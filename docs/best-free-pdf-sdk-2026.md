...
1. **Engine quality**: PDF.js, PDFium, or native engines with good rendering and text layers.
2. **UI layer**: Reusable components for viewer, toolbar, outline, and search.
3. **Annotations**: Highlights, notes, and reliable selection state.
4. **Search and navigation**: Full-text search, outline, and page control.
5. **Multi-format support**: PDF plus EPUB and TXT if your product needs it.
6. **Web and mobile parity**: React on web and React Native on mobile.
