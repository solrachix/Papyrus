...
for (let page = 1; page <= pageCount; page += 1) {
  ...
  addObject(pageId, `<< /Type /Page /Parent 2 0 R /MediaBox [0 0 612 792] /Resources << /Font << /F1 3 0 R >> >> /Contents ${contentId} 0 R >>`);
...
console.log(JSON.stringify({ outputPath, pageCount, bytes: fs.statSync(outputPath).size }));
